...
use theme_lexa\util\themehelper;
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        $classes = trim('card coursecard h-100');
        ...
        $content .= html_writer::end_tag('div'); // End coursebox.
        $content .= "<h3 class='hidden courseid'>$course->id</h3>";
        return $content;
    }
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $content = themehelper::get_course_summary_image($course, $courselink);
    ...
    protected function course_contacts(core_course_list_element $course) {
        ...
        if ($course->has_course_contacts()) {
            ...
            foreach ($instructors as $key => $instructor) {
                ...
                $picture = themehelper::get_user_picture($DB->get_record('user', array('id' => $key)));
