...
/**
 * Moves wrapping navigation items into a more menu.  Adapted from
 * original core code.
 *
 * @module     theme_lexa/primarymoremenu
...
/**
 * Adjust the primary more menu.
 *
 * @param {HTMLElement} menu The navbar moremenu.
 */
export default function adjustMenu(menu) {
    // Adjust menu.
    autoCollapse(menu);
